...
final readonly class TotalYearlyEarnedDashboardStatisticMapper implements DashboardStatisticMapperInterface
{
    ...
    public function map(User $user): DashboardStatistic
    {
        ...
        foreach ($user->getBills()->byType(TransactionType::Income) as $bill) {
        ...
        return new DashboardStatistic(
            $this->translator->trans('dashboard.statistic.total_yearly_earned'),
